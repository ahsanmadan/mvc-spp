                                            ...
                                            <?php if ($this->session->userdata['level'] == "admin"): ?>
                                                <td>
                                                    <?php if ($row['is_active'] == 0): ?>
                                                        <a href="<?= base_url('user/aAkun/') . $row['id_petugas'] ?>" type="button"
                                                            class="btn btn-gradient-success btn-sm">Aktifkan</a>
                                                    <?php else: ?>
                                                        <a href="<?= base_url('user/naAkun/') . $row['id_petugas'] ?>" type="button"
                                                            class="btn btn-gradient-danger btn-sm">Nonaktifkan</a>
                                                    <?php endif; ?>
                                                </td>
                                            <?php endif; ?>
                                            <td>
