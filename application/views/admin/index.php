  ...
  <body>
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row shadow-sm">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo" href="index.php"><img style="width:30px;height:40px;" src="<?= base_url('assets/'); ?>images/logo.png" alt="logo" /><span class="ms-3 fw-bold fs-5">Muda SPP</span></a>
          <a class="navbar-brand brand-logo-mini" href="index.php"><img src="<?= base_url('assets/'); ?>images/logo.png" style="width:30px;height:40px" alt="logo" /></a>
        </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mt-3">
                      <div class="col-6 pe-1">
                        <img src="<?= base_url('assets/'); ?>images/dashboard/img_1.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="<?= base_url('assets/'); ?>images/dashboard/img_4.jpg" class="mw-100 w-100 rounded" alt="image">
                      </div>
                      <div class="col-6 ps-1">
                        <img src="<?= base_url('assets/'); ?>images/dashboard/img_2.jpg" class="mb-2 mw-100 w-100 rounded" alt="image">
                        <img src="<?= base_url('assets/'); ?>images/dashboard/img_3.jpg" class="mw-100 w-100 rounded" alt="image">
                      </div>
                    </div>
                    <div class="d-flex mt-5 align-items-top">
                      <img src="<?= base_url('assets/'); ?>images/faces/face3.jpg" class="img-sm rounded-circle me-3" alt="image">
